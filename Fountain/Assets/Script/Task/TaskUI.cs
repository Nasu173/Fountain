...
public class TaskUI : MonoBehaviour
{
    ...
    /// <summary>
    /// 查找并获取所有UI子组件引用
    /// 通过路径查找，确保即使在Inspector中未拖拽也能自动获取
    /// </summary>
    ...
    public void Show()
    {
        ...
        if (isVisible) return; // �Ѿ��ɼ���ֱ�ӷ���

        StopAllCoroutines(); // ֹͣ�������ڽ��еĶ���
